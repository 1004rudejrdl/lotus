 ...
 <html lang="ko" dir="ltr">
   <head>
     ...
     <link rel="stylesheet" href="./css/cm_free_list.css">
     ...
     <script src="../../js/effect_common.js"></script>
       ...
       <div class="main_body">
         ...
         <div class="main">
           ...
           <div id="title1">
             <span class="notice1">NOTICE</span>
           </div>
          <hr>
                 ...
                 <div id="list_item">
                   <table id="customers">
                     <tr>
                       ...
                       <td id="list_title2"><a href="./cm_free_view.php?num=<?=$num?>&page=<?=$page?>&hit=<?=$hit+1?>"><?=$subject?></a></td>
  ...
  <br><br>
         ...
         <div id="button1">
           ...
           if (!empty($_SESSION['userid'])) {
             echo '<button type="button" name="button"><a href="./cm_free_write.php?page=<?=$page?>" id="write_page1">글쓰기</a></button>';
           }
