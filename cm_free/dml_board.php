...
if(isset($_GET["mode"])&&$_GET["mode"]=="insert"){
    ...
    $ord=0;
      ...
      include $_SERVER['DOCUMENT_ROOT']."/lotus/cm_free/lib/file_upload.php";
  ...
  //end of if rowcount
    ...
    mysqli_close($conn);
    echo "<script>location.href='./cm_free_list.php?page=1';</script>";
  ...
  if(empty($content) || empty($subject)){
    ...
    echo "<script>location.href='./cm_free_view.php?num=$num&page=1&hit=$hit';</script>";
  ...
  mysqli_close($conn);
  echo "<script>location.href='./cm_free_view.php?num=$parent&page=$page&hit=$hit';</script>";
}
