...
create_table($conn,'commu');//커뮤니티 테이블
create_table($conn,'commu_review');//성공후기 테이블
...
<html lang="ko" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="./css/cm_rv_list.css">
            ...
            <div id="list_item">
              <table id="customers">
                <tr>
                  ...
                  <td id="list_title2"><a href="./cm_rv_view.php?num=<?=$num?>&page=<?=$page?>&hit=<?=$hit+1?>"><?=$subject?></a></td>
        ...
        <div id="button1">
          ...
          $sql="SELECT matching from `member_meeting` where id = '$userid'"; //지금 로그인된 값만 확인해서 매칭값만 뽑아옴
            ...
            if (!empty($_SESSION['userid'])  && (!empty($matching))) {
              ...
              echo '<button type="button" name="button"><a href="./cm_rv_write.php?page=<?=$page?>" id="write_page1">글쓰기</a></button>';
            }
