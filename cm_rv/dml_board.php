...
if(isset($_GET["mode"])&&$_GET["mode"]=="insert"){
    ...
    $ord=0;
      ...
      include $_SERVER['DOCUMENT_ROOT']."/lotus/cm_rv/lib/file_upload.php";
      ...
      mysqli_close($conn);
      echo "<script> location.href='./cm_rv_view.php?num=$max_num&hit=$hit';</script>";
  //end of if rowcount
    ...
    mysqli_close($conn);
    echo "<script>location.href='./cm_rv_list.php?page=1';</script>";
  ...
  if(empty($content) || empty($subject)){
    ...
    echo "<script>location.href='./cm_rv_view.php?num=$num&page=1&hit=$hit';</script>";
  ...
  if(!$rowcount){
    ...
    mysqli_close($conn);
    echo "<script>location.href='./cm_rv_view.php?num=$q_parent&page=$page&hit=$hit';</script>";
}//end of if rowcount
  ...
  mysqli_close($conn);
  echo "<script>location.href='./cm_rv_view.php?num=$parent&page=$page&hit=$hit';</script>";
}
// ***********************************************
// ***********************************************
