...
--
-- Table structure for table `prd_acm_room`
--

DROP TABLE IF EXISTS `prd_acm_room`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `prd_acm_room` (
...
--
-- Dumping data for table `prd_acm_room`
--

LOCK TABLES `prd_acm_room` WRITE;
/*!40000 ALTER TABLE `prd_acm_room` DISABLE KEYS */;
/*!40000 ALTER TABLE `prd_acm_room` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-05-20  6:34:32
