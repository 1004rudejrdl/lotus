...
--
-- Table structure for table `prd_anl`
--

DROP TABLE IF EXISTS `prd_anl`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `prd_anl` (
...
--
-- Dumping data for table `prd_anl`
--

LOCK TABLES `prd_anl` WRITE;
/*!40000 ALTER TABLE `prd_anl` DISABLE KEYS */;
/*!40000 ALTER TABLE `prd_anl` ENABLE KEYS */;
UNLOCK TABLES;
