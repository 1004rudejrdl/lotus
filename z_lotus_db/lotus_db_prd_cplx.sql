...
--
-- Table structure for table `prd_cplx`
--

DROP TABLE IF EXISTS `prd_cplx`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `prd_cplx` (
...
--
-- Dumping data for table `prd_cplx`
--

LOCK TABLES `prd_cplx` WRITE;
/*!40000 ALTER TABLE `prd_cplx` DISABLE KEYS */;
/*!40000 ALTER TABLE `prd_cplx` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-05-20  6:34:30
