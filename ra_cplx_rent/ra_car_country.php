...
<div class="main">
  ...
  <div id="ranking1">
    <span id="ranking2">  | <a href="#"> 낮은가격순 </a>|<a href="#"> 높은가격순 </a>|<a href="#"> 판매량순 </a>|<a href="#"> 최신순 </a></span>
  </div><br>

  <div id="product">
    <fieldset id="product1">
      <fieldset id="product1_img">
        <img src="./img/a.png" alt="이미지테스트" width="300px" height="300px">
      </fieldset>
    </fieldset>
