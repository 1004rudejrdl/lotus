...
<div class="btn_center">
  <div class="btn_submit btn_5">
    <a href="./cm_qna_list.php?page=<?=$page?>" class="write_page1">목 록 </a>
         <?php
         ...
         if (isset($_SESSION['userid'])) {
           if($_SESSION['userid']==$id){
             ...
             echo '<a href="./cm_qna_write.php?mode=update&num='.$num.'" class="write_page1">수 정</a>';
         ...
         if (!empty($_SESSION['userid'])) {
           echo '<a href="./cm_qna_write.php?mode=response&num='.$num.'" class="write_page1">답 변</a>';
           echo '<a href="./cm_qna_write.php" class="write_page1">글쓰기</a>';
         }
         mysqli_close($conn);
         ?>
       </div>           <!-- btn_submit end -->
