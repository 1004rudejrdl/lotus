  ...
  <body>
    ...
    <script src="../../js/effect_common.js"></script>
      ...
      <div class="main_body">
        ...
        <div>
          ...
          <?php
            ...
            if (!empty($_SESSION['userid'])) {
              echo '<button class="btn_write" type="button" name="button"><a href="./cm_gath_write.php?page=<?=$page?>" id="write_page1">글쓰기</a></button>';
            }
           ?>
        </div>
        <?php
        ...
        <a href="./cm_gath_list.php?page=1">◀◀</a>
        <?php
        if ($page>1) {
            $page_go=$page-1;
             echo '<a class="previous" href="./cm_gath_list.php?page='.$page_go.'">이전 ◀</a>';
           }else {
             echo '<a class="previous" href="./cm_gath_list.php?page=1">이전 ◀</a>';
           }
           ...
           if ($total_page==0) {
             echo '<a class="next" href="./cm_gath_list.php?page=1">▶ 다음</a>';
           }elseif ($page+1>$total_page) {
             $page_end=$total_page;
             echo '<a class="next" href="./cm_gath_list.php?page='.$page_end.'">▶ 다음</a>';
           }else{
             $page_go=$page+1;
             echo '<a class="next" href="./cm_gath_list.php?page='.$page_go.'">▶ 다음</a>';
           }
           ?>
        <a href="./cm_gath_list.php?page=<?=$total_page?>">▶▶</a>
