...
<div class="main">
  <form name="login_form" action="member_join.php?mode=member_modify" method="post" enctype="multipart/form-data">
    <table>
      <th>로그인</th>
      <tr>
        <td colspan="3" rowspan="4"><img id="profile_image" src="<?=$img?>" style="width:430px;height:300px;" > </td>
        <td > <label id="login_table_id_label">아이디</label></td>
        <td colspan="5"><input type="text" name="id"  id="login_form_id" value="<?=$id?>" readOnly> </td>
      ...
      <tr>
        <td>주소</td>
        <td colspan="4">
          <input type="text" name="postcode" id="postcode" value="<?=$postcode?>" placeholder="우편번호">
  <input type="button" onclick="execDaumPostcode()" value="우편번호 찾기"><br>
  <input type="text" name="address" id="address" value="<?=$address?>" placeholder="주소"><br>
  <input type="text" name="detailAddress" id="detailAddress" value="<?=$detailAddress?>" placeholder="상세주소" required>
  ...
  <script>
      function execDaumPostcode() {
        ...
        <td>생일</td>
        <td colspan="4">
          Date: <input type="text" name="datepicker" value="<?=$birth?>" id="datepicker">
        </td>
      </tr>
      <tr>
        <td>직업</td>
        ...
        <td>핸드폰번호</td>
        <td colspan="4"><input type="text" id="phone_num" name="phone_num" value="<?=$tel?>" placeholder="전화번호를 입력하세요"> </td>
      </tr>
      <tr>
        <td>키</td>
        <td colspan="4"><input type="text" id="mem_hei" name="mem_hei" value="<?=$height?>" placeholder="키를 입력하세요"> </td>
        <td>체중</td>
        <td colspan="4"><input type="text" id="mem_wei" name="mem_wei" value="<?=$weight?>" placeholder="체중을 입력하세요"> </td>
      </tr>
    </table>
    <p>성별 변경은 관리자에게 문의하세요.</p>
