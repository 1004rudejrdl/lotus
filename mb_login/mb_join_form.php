      ...
      <form name="login_form" action="member_join.php?mode=member_join" method="post" enctype="multipart/form-data">
        ...
        <table class="admin_table">
          <tr>
            ...
            <td class="tb_cont">
              <input type="text" name="id" id="login_form_id" value="" placeholder="아이디를 입력하세요." required>
          ...
          <tr>
            ...
            <td class="tb_cont">
              <input type="password" name="pw" id="login_form_pw" value="" placeholder="영문,숫자,특수문자" required>
          ...
          <tr>
            ...
            <td class="tb_cont">
              <input type="password" name="pw" id="login_form_id_chk" value="" placeholder="영문,숫자,특수문자" required>
          ...
          <tr>
            ...
            <td class="tb_cont">
              <input class="shorter addr" type="text" name="postcode" id="postcode" placeholder="우편번호">
              <input class="shorter addr" type="button" onclick="execDaumPostcode()" value="우편번호 찾기">
              <br>
              <input class="addr" type="text" name="address" id="address" placeholder="주소">
              <input class="addr" type="text" name="detailAddress" id="detailAddress" placeholder="상세주소" required>
              <br>
        ...
        <table class="admin_table">
          <tr>
            ...
            <td class="tb_cont">
              <input type="text" name="datepicker" id="datepicker" placeholder="클릭하여 선택하세요">
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="tb_cont">
              <input type="text" id="phone_num" name="phone_num" placeholder=" - 없이 11자리 입력">
        ...
        <table class="admin_table">
          ...
          <tr>
            <td colspan="2" class="p_img"><img id="profile_image"></td>
          </tr>
        </table>
