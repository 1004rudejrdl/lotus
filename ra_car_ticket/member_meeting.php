    ...
    <div class="main">
      ...
      <form action="countrt_insert.php" method="post" name="country_form">
        <table class="table1" style="width:70%;">
          ...
          <tr>
            <td style="width:210px;"><span style="color:rgb(240, 165, 0);">*</span> 직업</td>
            <td><input type="text" name="admin_employee" class="div_none" placeholder="ex) 직업" autofocus></td>
          </tr>
          <tr>
            <td style="width:210px;"><span style="color:rgb(240, 165, 0);">*</span> 회원번호</td>
            <td><input type="text" name="admin_member_num" class="div_none" placeholder="ex)영문, 숫자 특수문자 조합" autofocus></td>
          </tr>
          <tr>
            <td style="width:210px;"><span style="color:rgb(240, 165, 0);">*</span> 매칭일자</td>
          ...
          <tr>
            <td style="width:210px;"><span style="color:rgb(240, 165, 0);">*</span> 회원구분</td>
            <td><select class="" name="admin_member" autofocus>
              <option>유료&nbsp;</option>/
              <option>무료&nbsp;</option>
            </select></td>
          </tr>
          <tr>
            <td style="width:210px;"><span style="color:rgb(240, 165, 0);">*</span> 좋아요</td>
            <td><select class="" name="admin_like" autofocus>
              <option>Y&nbsp;</option>
              <option>N&nbsp;</option>
            </select></td>
          </tr>
          <tr>
            <td style="width:210px;"><span style="color:rgb(240, 165, 0);">*</span> 자기소개</td>
            <td><textarea name="admin_introduce" rows="8" cols="80"></textarea></td>
          </tr>
