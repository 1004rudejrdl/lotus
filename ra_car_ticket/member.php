    ...
    <div class="main">
      ...
      <form action="countrt_insert.php" method="post" name="country_form">
        <table class="table1" style="width:60%;">
          <tr>
            <td style="width:210px;"><span style="color:rgb(240, 165, 0);">*</span> 회원 번호</td>
            <td>
              <select>
                <?php
                $i=0;
          ...
          <tr>
            <td style="width:210px;"><span style="color:rgb(240, 165, 0);">*</span> 이메일</td>
            <td><input type="text" name="time_spent" class="div_none" placeholder="ex)" autofocus></td>
          </tr>
          <tr>
            <td style="width:210px;"><span style="color:rgb(240, 165, 0);">*</span> 전화번호</td>
            <td><textarea name="note_contents" rows="8" cols="80" autofocus></textarea></td>
          </tr>
          <tr>
            <td style="width:210px;"><span style="color:rgb(240, 165, 0);">*</span> 생  일</td>
            <td><textarea name="note_contents" rows="8" cols="80" autofocus></textarea></td>
          </tr>
          <tr>
            <td style="width:210px;"><span style="color:rgb(240, 165, 0);">*</span> 성  별</td>
            <td><textarea name="note_contents" rows="8" cols="80" autofocus></textarea></td>
          </tr>
          <tr>
            <td style="width:210px;"><span style="color:rgb(240, 165, 0);">*</span> 우편번호</td>
            <td><textarea name="note_contents" rows="8" cols="80" autofocus></textarea></td>
          </tr>
          <tr>
            <td style="width:210px;"><span style="color:rgb(240, 165, 0);">*</span> 우편상세주소</td>
            <td><textarea name="note_contents" rows="8" cols="80" autofocus></textarea></td>
          </tr>
          <tr>
            <td style="width:210px;"><span style="color:rgb(240, 165, 0);">*</span> 블랙리스트여부</td>
            <td><textarea name="note_contents" rows="8" cols="80" autofocus></textarea></td>
          </tr>
          <tr>
            <td style="width:210px;"><span style="color:rgb(240, 165, 0);">*</span> 네이버 아이디</td>
            <td><textarea name="note_contents" rows="8" cols="80" autofocus></textarea></td>
          </tr>
          <tr>
            <td style="width:210px;"><span style="color:rgb(240, 165, 0);">*</span> 카카오 아이디</td>
            <td><textarea name="note_contents" rows="8" cols="80" autofocus></textarea></td>
          </tr>
          <tr>
            <td style="width:210px;"><span style="color:rgb(240, 165, 0);">*</span> 페이스북 아이디</td>
            <td><textarea name="note_contents" rows="8" cols="80" autofocus></textarea></td>
          </tr>
          <tr>
            <td style="width:210px;"><span style="color:rgb(240, 165, 0);">*</span> 구글 아이디</td>
            <td><textarea name="note_contents" rows="8" cols="80" autofocus></textarea></td>
          </tr>
