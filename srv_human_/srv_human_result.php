...
<html lang="ko" dir="ltr">
  <head>
    ...
    <script type="text/javascript" src="./srv_human_form.js"></script>
  ...
  <body>
    ...
    <div id="chart_div2" style="width:600px; height:600px;">

    </div>
    <div id="chart_div3" style="width:600px; height:600px;">

    </div>
    <div id="chart_div4" style="width:600px; height:600px;">

    </div>
    <div id="chart_div5" style="width:600px; height:600px;">
