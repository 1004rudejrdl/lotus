...
폴더관리 방법 
0. 원칙 - 반드시 원본이 존재 해야한다.
1. pull한 것을 바탕화면에 놓는다. (그날 받은 최초 원본이 됨)
2. 작업폴더에 바탕화면에 받은 것을 붙여넣기한다.
3. 작업한다.
4. 작업을 마치면 pull로 당겨서 새로 받는다
5. pull로 당겨서 받은 바탕화면에 내가 작업한 폴더에서 변경된 사항을 덮어쓰기한다. (다른 사람작업+내 작업까지 가장 최신 버전이 됨)
6. 덮어쓰기를 마친 바탕화면의 폴더를 작업폴더에 붙여 넣는다.
7. 양쪽 모두 같은지 확인하고 커밋 풀 푸쉬 진행
